<?php
// source: C:\xampp\htdocs\nette-weather-api/config/common.neon
// source: C:\xampp\htdocs\nette-weather-api/config/services.neon
// source: array
...
class Container_20e8ca9703 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presentation\ApiPresenter' => [2 => ['application.1']],
		...
		'App\Presentation\HomePresenter' => [2 => ['application.4']],
	...
	public function createService02(): App\Model\WeatherService
	{
		return new App\Model\WeatherService($this->getParameter('env')['VISUALCROSSING_API_KEY'], $this->getService('cache.storage'));
	}
	...
	public function createService04(): App\Model\RateLimiter
	{
		return new App\Model\RateLimiter($this->getService('cache.storage'));
	}


	public function createService05(): App\Presentation\ApiResponse
	{
	...
	public function createServiceApplication__4(): App\Presentation\HomePresenter
	{
		$service = new App\Presentation\HomePresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\nette-weather-api/temp/cache/nette.application/touch',
		));
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('C:\xampp\htdocs\nette-weather-api\www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_20e8ca9703 $container,
			) {
			}
	...
	{
		return [
			'appDir' => 'C:\xampp\htdocs\nette-weather-api\app',
			'wwwDir' => 'C:\xampp\htdocs\nette-weather-api\www',
			'vendorDir' => 'C:\xampp\htdocs\nette-weather-api\vendor',
			'rootDir' => 'C:\xampp\htdocs\nette-weather-api',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\nette-weather-api/temp',
		];
	}
